...
describe('RatingFilter', () => {
  ...
  describe('shouldShowRow', () => {
    it('should return false if row is undefined', () => {
      const filter = new RatingFilter();
      filter.selectableOptions = allOptions;
      expect(filter.shouldShowRow(undefined)).toBe(false);
    });

    it('should return false if row is an empty array', () => {
      const filter = new RatingFilter();
      filter.selectableOptions = allOptions;
      expect(filter.shouldShowRow([])).toBe(false);
    });

    it('should return true if selectedValue is undefined', () => {
      const filter = new RatingFilter();
    ...
    it('should return true if selectedValue is ---', () => {
      const filter = new RatingFilter();
      const sampleRow = [1, 1650];
      filter.selectableOptions = allOptions;
    ...
    it('should return true if filteredColumnIndex is not set', () => {
      const filter = new RatingFilter();
      const sampleRow = [1, 1650];
      filter.selectableOptions = allOptions;
    ...
    it('should return true if filteredColumnIndex is >= than the length of the row array', () => {
      const filter = new RatingFilter();
      const sampleRow = [1, 1650];
      filter.selectableOptions = allOptions;
      filter.selectedValue = '1800 - 1999';
    ...
    it('should return true if the target value in the row matches the selected value', () => {
      const filter = new RatingFilter();
    ...
    it('should return false if the target value in the row does not match the selected value', () => {
      const filter = new RatingFilter();
  ...
  describe('selectedValue', () => {
    it('should set selected value if the arg is among available options', () => {
      const filter = new RatingFilter();
      filter.selectableOptions = [1650];
      filter.selectedValue = '1600 - 1799';

      expect(filter.selectedValue).toEqual('1600 - 1799');
    });

    it('should set selected value to NO_FILTER if the arg is not among available options', () => {
      const filter = new RatingFilter();
      filter.selectableOptions = [1650];
      filter.selectedValue = '1800 - 1999';
